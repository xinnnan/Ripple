...
- 845 committed unit/contract tests, production HTTP smoke, and an opt-in
...
61. **Next local integrity work:** run protected positive/rollback probes when
    fixtures are available; otherwise inventory remaining browser Supabase
    reads and harden the next coherent settings/write-form slice.
