...
- 866 committed unit/contract tests, production HTTP smoke, and an opt-in
...
70. **P0-BT — closed in `904fee0`, migration pending:** Migration 048 adds a
    ...
    gates are green.
71. **Deployment gate:** apply migration 048 before deploying `904fee0`, run
    its disposable exact-replay, altered-input, concurrency, outbox-cardinality,
    privilege-denial, and zero-residue matrix, then resume the remaining
